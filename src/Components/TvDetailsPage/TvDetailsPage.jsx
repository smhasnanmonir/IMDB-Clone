...
const TvDetailsPage = () => {
  ...
  console.log(singleTvCastsData);
  return (
    <div className="grid md:w-3/4 mx-auto pb-[45px] px-[5%]">
      <>
      ...
      <>
        <h1 className="py-[25px] text-2xl font-semibold">Photos</h1>
      ...
      <>
        <h1 className="text-2xl py-[25px] font-semibold">Top Stars</h1>
